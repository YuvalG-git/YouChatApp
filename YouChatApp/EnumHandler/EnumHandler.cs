...
{
    /// <summary>
    /// The "EnumHandler" class contains enums for various purposes, such as login phases, registration phases, password reset phases, message types and communication message IDs.
    /// </summary>
    public static class EnumHandler
    {
        ...
        /// <summary>
        /// Enum representing different phases of the login process.
        /// </summary>
        public enum LoginPhases_Enum
        {
            /// <summary>
            /// Represents the phase where the user is prompted to login.
            /// </summary>
            Login,

            /// <summary>
            /// Represents the phase where SMTP settings are configured.
            /// </summary>
            Smtp,

            /// <summary>
            /// Represents the phase where a captcha code is required for login.
            /// </summary>
            CaptchaCode,

            /// <summary>
            /// Represents the phase where a rotating captcha image is used for login.
            /// </summary>
            CaptchaRotatingImage,

            /// <summary>
            /// Represents the phase where a verification question is asked for login.
            /// </summary>
            VerificationQuestion
        }

        /// <summary>
        /// Enum representing different phases of the registration process.
        /// </summary>
        public enum RegistrationPhases_Enum
        {
            ...
            /// <summary>
            /// Represents the phase where user registration is completed.
            /// </summary>
            Registration
        }

        /// <summary>
        /// Enum representing different phases of the password reset process.
        /// </summary>
        public enum PasswordResetPhases_Enum
        {
            /// <summary>
            /// Represents the phase where user data is collected.
            /// </summary>
            UserData,
            ...
            /// <summary>
            /// Represents the phase where the password is reset.
            /// </summary>
            PasswordReset
        }
